        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <h2 className="text-2xl font-bold text-purple-600 mb-4">We'd Love to Hear From You</h2>
              <p className="mb-4">
                Have questions about our typing lessons? Want to share feedback or suggestions? Use the form to get in
                touch with us.
              </p>
              <p className="mb-4">
