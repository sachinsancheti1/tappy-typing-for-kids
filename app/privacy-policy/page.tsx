...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for the Typing for Kids interactive typing book website",
}
    ...
    <main className="min-h-screen bg-orange-50">
      <div className="max-w-4xl mx-auto p-6 py-12">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="mb-4">
            Welcome to Typing for Kids ("we," "our," or "us"). We are committed
            to protecting your privacy and personal information. This Privacy
            Policy explains how we collect, use, disclose, and safeguard your
            information when you visit our website typing-for-kids.netlify.app,
          ...
          <p className="mb-4">
            ...
            you voluntarily provide to us, such as your name and email address
          ...
          <p className="mb-4">
            ...
            location, information about how and when you use our Site, and other
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <li>
              ...
              partners, for customer service, updates, and other website-related
              information
            </li>
          ...
          <p className="mb-4">
            We use third-party Service Providers to monitor and analyze the use
            of our Service.
          </p>
          <h3 className="text-xl font-bold text-orange-500 mt-6 mb-3">
            Google Analytics
          ...
          <p className="mb-4">
            Microsoft Clarity is a user behavior analytics tool that helps us
            understand how users interact with our website. It uses session
            replay technology to recreate a user&apos;s journey on our website
            and provides heatmaps to visualize where users click, scroll, and
            spend time.
          </p>
          ...
          <p className="mb-4">
            Our Service is intended for use by children, but only with parental
            supervision. We do not knowingly collect personally identifiable
            information from children under 13 without parental consent. If you
